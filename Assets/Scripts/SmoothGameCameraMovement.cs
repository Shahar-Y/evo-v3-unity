...
// Got the base code from https://gist.github.com/IRCSS/f4d4a274e7ac71dcaebef63bbe717a31
// Moves Camera similar to how camera is moved in the Unity view port.
// Drop the scrip on the game object which has the camera and you wish to move. 
...
public class SmoothGameCameraMovement : MonoBehaviour
{
    ...
    // TransformDummy Attaches to the main camera and moves it around the scene. 
    ...
    void Update()
    {
        ...
        this.transform.position += this.transform.forward * longitudinal* speedMultiplyer * timeStep();
